      ...
      <section className="relative overflow-hidden bg-charcoal">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          ...
          <h1 className="font-display text-4xl font-black uppercase leading-[1.05] tracking-tight text-mist sm:text-6xl">
            あなたに合う
            <br />
            <span className="inline-block">山小屋を、迷わず</span><wbr /><span className="inline-block text-trail">見つける。</span>
          </h1>
          <p className="mt-5 max-w-xl text-base text-mist/70">
            <span className="inline-block">エリア・標高・水場・電波の条件で絞り込んで、</span><wbr /><span className="inline-block">次の登山で</span><wbr /><span className="inline-block">泊まりやすい</span><wbr /><span className="inline-block">山小屋を</span><wbr /><span className="inline-block">探せます。</span>
          </p>
          <Link
            href="/gear"
